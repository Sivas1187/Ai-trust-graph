...
| 2 | Core Conceptual Model | 1.1 | Public-release candidate | `docs/02-core-conceptual-model.md` | `c79250aef151a4384e3a8b47cde3e5987013bfa7` |
...
| 12 | Ontology Specification | 1.0 | Public-release candidate | `docs/12-ontology-specification.md` | `8ed9b1f5c6180ac54178276fa949a753dc8a8971` |

### Phase 2 non-normative companion

| Artifact | Version | Status | Path | Git blob SHA |
| --- | --- | --- | --- | --- |
| Reference Graph Schema and Illustrative Query Library | 0.2 | Non-normative | `docs/13-reference-graph-schema-and-query-library.md` | `3e80c5f3cddbad0a37b680aabb3798d204d53818` |
