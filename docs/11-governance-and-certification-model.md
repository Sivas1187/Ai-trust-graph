...
| Depends on | Artifacts #1-#10 |
| Governed objects | Artifacts, schemas, assessors, reviewers, tools, extensions, assessments, reports, certificates and marks |
| Certification posture | Scheme-ready design; operational certification prohibited until independent legal, scheme-owner and accreditation gates close |
| Product boundary | ExposureGraph implementation, proprietary algorithms, connectors, customer data and commercial operations excluded |

# 0.1  Authority and constitutional boundary
...
The invariants below override commercial pressure, schedule, popularity, tool convenience and founder preference.

| **ID** | **Invariant** |
| --- | --- |
| GOV-INV-01 | Canonical meaning cannot be changed by a tool implementation. |
| GOV-INV-02 | Commercial revenue cannot influence technical or certification decisions. |
| GOV-INV-03 | UNKNOWN remains visible and cannot be certified away. |
| GOV-INV-04 | A high score cannot override a critical gate. |
| GOV-INV-05 | Certification scope cannot exceed assessed scope and evidence period. |
| GOV-INV-06 | Training and certification decisions require managed impartiality. |
| GOV-INV-07 | Appeal review cannot be performed by the original decision maker alone. |
| GOV-INV-08 | Marks cannot imply accreditation that has not been granted. |
| GOV-INV-09 | A certificate cannot guarantee future system behavior. |
| GOV-INV-10 | Revoked or expired status must remain publicly distinguishable from valid status. |

# 0.6  Governed-object registry
...
Public certification claims require independent validation of the scheme, legal terms, competence model, impartiality, quality system and applicable accreditation pathway.
...
The structure separates stewardship, technical authority, certification decisions, impartiality oversight, appeals and administration.

| **Body** | **Primary accountability** |
| --- | --- |
| Methodology Steward | Custody of canonical artifacts and roadmap; no unilateral certification decision. |
| Governance Council | Approves policy, major releases, scheme boundaries and appointments. |
| Technical Architecture Board | Protects conceptual, ontology, control, evidence and scoring integrity. |
| AI Security Review Board | Challenges threat, authority, validation, resilience and unsafe-use implications. |
| Certification Scheme Committee | Maintains certification requirements, scope, competence and surveillance rules. |
| Impartiality Committee | Monitors threats to impartiality and has escalation rights. |
| Appeals Panel | Reviews contested decisions independently of the original decision chain. |
| Secretariat | Manages records, notices, minutes, registers and publication operations. |
| Maintainers | Implement approved changes and repository releases. |
| Community Contributors | Propose issues, evidence, cases and extensions without approval authority. |

# 1.2  Methodology Steward
...
Each body declares quorum, voting threshold, abstention, recusal, tie, urgent-decision and ratification rules.

| **Decision class** | **Default approval rule** |
| --- | --- |
| Routine maintenance | Simple majority with quorum |
| Minor release | Two-thirds of voting members with technical review |
| Major release | Two-thirds plus Governance Council and independent review |
| Constitutional amendment | Three-quarters plus public consultation |
| Certification decision | Authorized decision maker independent of evaluation |
| Appeal | Independent panel majority; conflicted members recuse |
...
Constitutional, semantic, normative, operational, illustrative, machine-readable and extension artifacts have different approval thresholds.

| **Class** | **Examples** | **Approval** |
| --- | --- | --- |
| Constitutional | Governance and Certification Model | Highest threshold |
| Semantic | Conceptual Model and ontology | Architecture Board plus Council |
| Normative | Maturity, Scoring, Controls, Evidence, Assessment, Reporting | Technical boards plus Council |
| Operational | Handbook and operating procedures | Scheme owner plus QA |
| Illustrative | Reference assessments and examples | Maintainer plus independent calibration review |
| Machine-readable | Schemas and test vectors | Technical board plus conformance tests |
| Extension | Sector or technology extension | Extension panel plus compatibility review |

# 2.3  Semantic versioning

Major changes break compatibility; minor changes add backward-compatible capability; patch changes correct defects without intended semantic change.

| **Version change** | **Trigger** | **Migration** |
| --- | --- | --- |
| Major | Breaking semantics, formula, control IDs, result states or certification requirements | Formal migration and compatibility break |
| Minor | Backward-compatible controls, examples, fields or guidance | Adoption plan and declared compatibility |
| Patch | Defect, typo or non-semantic clarification | Correction note; reassess only if conclusion affected |
...
# 3.2  Assessor levels A1-A5

The five handbook levels become governed authorization bands rather than honorary titles.

| **Level** | **Governed authority** |
| --- | --- |
| A1 Associate | Support evidence, inventory and workpapers under supervision |
| A2 Assessor | Execute standard procedures for bounded scope |
| A3 Senior | Lead domain fieldwork and draft material conclusions |
| A4 Lead | Integrate assessment and recommend release |
| A5 Principal Reviewer | Independently challenge gates, maturity, scoring and release |

# 3.3  Reviewer authorization
...
Levels indicate claim depth and cannot be presented as maturity, security, compliance or certification of the assessed AI system.
...
# 5.2  Certifiable objects

Potential schemes may address persons, assessment processes, services or tools, but each requires a separate scope and conformity-assessment design.

| **Potential scheme** | **Object** | **Readiness boundary** |
| --- | --- | --- |
| Person certification | Assessor or reviewer competence | Separate examination and personnel scheme required |
| Process certification | Assessment delivery process | Process requirements and surveillance required |
| Service certification | Assessment or assurance service | Service outcome and delivery controls required |
| Tool certification | Software conformance | Schema, calculation, security and version test suite required |
| Organization maturity claim | Scoped capability profile | Not certification unless a dedicated scheme is independently established |

# 5.3  Prohibited certification claims

The ecosystem cannot certify guaranteed AI safety, universal trustworthiness, legal compliance, absence of vulnerabilities or future behavior.

| **Prohibited wording** | **Reason** |
| --- | --- |
| AI is safe | Cannot guarantee absence of future harm or failure |
| AI is trustworthy | Undefined composite claim exceeds bounded evidence |
| Legally compliant | Requires jurisdiction-specific legal determination |
| No vulnerabilities | Point-in-time assessment cannot prove absence |
| Certified risk-free | Risk cannot be eliminated by certificate |
| Accredited | Prohibited without granted accreditation scope |

# 5.4  Scheme specification
...
Operational launch requires approved scheme documents, impartial governance, competent personnel, quality system, legal terms, secure records, pilots and applicable accreditation strategy.
...
# 6.3  Impartiality risk register
...
Draft, Consultation, Candidate, Approved, Deprecated, Withdrawn and Superseded have controlled meanings.
...
# 11.2  Certification status states

Applicant, Under Evaluation, Certified, Conditioned, Suspended, Expired, Withdrawn and Revoked are distinct.
...
| Certified | Valid within published scope and dates |
| Conditioned | Valid only with explicit conditions |
| Suspended | Claim and mark use restricted or stopped |
| Expired | Term ended without current certification |
| Withdrawn | Holder or body ended certification |
| Revoked | Certification removed for cause |
...
The matrix separates proposal, review, approval, implementation, monitoring and appeal.

| **Decision** | **Steward** | **Council** | **Technical Board** | **Scheme Committee** | **Impartiality** | **Appeals** |
| --- | --- | --- | --- | --- | --- | --- |
| Major artifact release | R | A | R | C | C | - |
| Certification scheme launch | C | A | C | R | R | - |
| Individual certification decision | - | - | - | A/R | C | Appeal only |
| Conformance-tool release | C | A | R | C | C | Appeal only |
| Constitutional amendment | R | A | R | C | C | - |
| Suspension or revocation | - | - | C | A/R | C | Appeal |

# A.2  Compatibility declaration template

A declaration is complete only when it states exact objects and limitations.

| **Field** | **Required content** |
| --- | --- |
| Declarant | Legal entity and accountable person |
| Object | Artifact, process, report, tool or service |
| Profile | Named conformance profile |
| Versions | All applicable artifact and schema versions |
| Scope | Boundary, environment, period and exclusions |
| Evidence | Tests, records and reviewer |
| Limitations | UNKNOWN, exceptions and unsupported claims |
| Status | Date, expiry, surveillance and supersession |

# A.3  Certificate minimum-content template

This template is not authority to issue a certificate.

| **Field** | **Required content** |
| --- | --- |
| Certificate identifier | Unique and verifiable |
| Holder | Legal name and relevant location |
| Certified object | Person, process, service or tool |
| Scope | Precise boundary and exclusions |
| Normative baseline | Scheme and artifact versions |
| Decision | Grant date and authorized decision maker |
| Validity | Effective date, expiry and surveillance |
| Status source | Public verification location |
| Restrictions | Conditions and prohibited claims |
| Marks | Approved mark and use terms |

# A.4  Impartiality-threat register

Threats are assessed before assignment and throughout the relationship.

| **Threat** | **Example control** |
| --- | --- |
| Self-review | Independent review and decision |
| Financial self-interest | Outcome-neutral compensation |
| Advocacy | Separate consulting and certification |
| Familiarity | Rotation or added review |
| Intimidation | Escalation and protected reporting |
| Training linkage | Separate examination and decision |
| Ownership | Governance and divestment or exclusion |
| Commercial pressure | Impartiality committee oversight |

# A.5  Appeal decision template

An appeal outcome must be reconstructable and independent.

| **Field** | **Required content** |
| --- | --- |
| Appeal ID | Stable identifier |
| Original decision | Object, date and authority |
| Appellant | Standing and requested remedy |
| Panel | Competence, independence and recusals |
| Evidence | Submissions and additional investigation |
| Analysis | Criteria, facts and procedural issues |
| Decision | Affirm, vary, remit, correct or overturn |
| Notice | Reason, effect, date and further route |

# A.6  Sanction matrix

Sanctions are proportionate and do not replace due process.

| **Condition** | **Potential response** |
| --- | --- |
| Minor first-use mark error | Correction and education |
| Repeated misleading claim | Formal warning or mark suspension |
| Material competence failure | Scope restriction or suspension |
| Evidence fabrication | Investigation and possible revocation |
| Unsafe unauthorized testing | Immediate restriction and investigation |
| Bribery or collusion | Suspension, revocation and referral as applicable |
| Failure to cease expired claim | Public correction and enforcement |

# A.7  Source and derivation register

The model consolidates predecessor AI Trust Graph governance needs and uses external conformity-assessment sources only as boundary guidance.

| **Source** | **Use** |
| --- | --- |
| Artifacts #1-#10 | Canonical meaning, controls, evidence, assessment, competence, reporting and cases |
| Singapore Accreditation Council certification-body guidance | Accreditation-body and mark-use boundary |
| ISO/IEC 17021-1 reference in SAC guidance | Management-system certification-body pathway reference |
| ISO/IEC 17024 public accreditation descriptions | Personnel-certification pathway reference |
| ISO/IEC 17065 public accreditation descriptions | Product, process and service certification-body pathway reference |
| Original methodology design | Governance constitution, roles, change control, profiles and safeguards |

# A.8  Certification-launch gate checklist

No operational certification may launch until all gates close.

| **Gate** | **Acceptance criterion** |
| --- | --- |
| Scheme validity | Object, requirements and evaluation are coherent |
| Legal authority | Entity, contracts, terms and liability reviewed |
| Impartiality | Committee, register and structural controls operating |
| Competence | Evaluators, reviewers and decision makers authorized |
| Quality system | Records, audit, review and corrective action operating |
| Assessment security | Identity, examination, evidence and records protected |
| Pilot evidence | Representative pilots and decision consistency completed |
| Appeals | Independent process and panel operational |
| Marks | Trademark and use rules approved |
| Accreditation strategy | Applicable pathway evaluated; no false accreditation claim |

# A.9  Ruthless reviewer release checklist

A public candidate must survive constitutional, scheme, security, legal and usability challenge.

| **Review area** | **Acceptance criterion** |
| --- | --- |
| Constitution | No role can bypass invariants |
| Governance | Authority, quorum, recusal and records explicit |
| Change control | Version, impact, consultation and migration complete |
| Competence | Authorization, calibration, renewal and sanctions complete |
| Conformance | Profiles and claim boundaries unambiguous |
| Certification | Evaluation, review and decision separated |
| Impartiality | Structural and case threats controlled |
| Appeals | Independent remedy and due process complete |
| IP and marks | No unauthorized accreditation implication |
| Sunset | Withdrawal and historical integrity preserved |
| Accessibility | Headings and tables pass audit |
| Visual QA | All rendered pages inspected |

# A.10  Final doctrine and approval record

Govern transparently. Separate evaluation from decision. Protect impartiality. Certify only bounded objects. Never promise safety or compliance. Preserve history. Provide appeal.

> **GOVERNANCE DOCTRINE** AI Trust Graph may define certification readiness, but only a separately validated and properly governed scheme may issue certification.
...
| Certification-scheme review | Independent validation pending |
| Legal, privacy and accreditation-path review | Pending |
| Employer / IP / confidentiality review | Pending |
| Licence and trademark approval | Pending |
| Operational certification launch | Prohibited until all launch gates close |

Governance constitution | Certification-readiness model | Public-release candidate
